...
* Senior Developer / Team Lead (_October 2015 - August 2017_)
  ...
  * Routinely collaborate & code review with team, help mentor new developers
  * Built robust, modular single page applications while integrating with client services and APIs - Developed a full-stack javascript mobile web application utilizing Cordova
* Web developer (_March 2014 - October 2015_) -
  ...
  * Utilized Cordova to create a high profile ios/android application - Regularly communicated with clients to determine requirements, and demo and review progress

#### Sparxoo

* Web/mobile developer (_April 2013 - Feb 2014_)
  * Developed responsive websites for a multitude of clients using PHP, HTML, CSS, jQuery and SQL
  * Developed rich CMS integration through plugins for various CMS platforms
  * Trained clients on CMS & site usage
  * Created email campaigns and any additional promotional assistance required
  * Adhere to strict deadlines while handling multiple projects
...
* Full Sail University (_2011 - 2013_)

  * BS, Web Design & Development
  * Salutatorian

* University of Central Florida (_2006-2011_)
